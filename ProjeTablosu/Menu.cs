...
namespace ProjeTablosu
{
    class Menu
    {
        public void AddMenuItems()
        {
            ...
            oCreationPackage.UniqueID = "ProjeTablosu";
            ...
            try
            {
                ...
                oMenuItem = Application.SBO_Application.Menus.Item("ProjeTablosu");
                oMenus = oMenuItem.SubMenus;
            ...
            {
                // Menü zaten mevcutsa hata alınır, bu durumda loglama yapabilirsiniz.
            }
        }
        ...
        public void SBO_Application_MenuEvent(ref SAPbouiCOM.MenuEvent pVal, out bool BubbleEvent)
        {
            ...
            try
            {
                ...
                {
                    if (pVal.MenuUID == "ProjeTablosu.Form1")
                    {
                        Form1 activeForm = new Form1();
                        activeForm.Show();
                    }
                    else if (pVal.MenuUID == "ProjeTablosu.Form2")
                    {
